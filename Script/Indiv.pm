...
"<head><title>Choose a transcript</title><link rel=\"stylesheet\" type=\"text/css\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot.css\"/><link rel=\"icon\" type=\"image/png\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot16x16.png\" sizes=\"16x16\"/><link rel=\"icon\" type=\"image/png\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot32x32.png\" sizes=\"32x32\"/><link rel=\"icon\" type=\"image/png\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot186x186.png\" sizes=\"186x186\"/><script type=\"text/javascript\" src=\"http://lysine.univ-brest.fr/GEMPROT/gemprot.js\"></script></head>\n";
    print INDEX
"<div w3-include-html=\"http://lysine.univ-brest.fr/GEMPROT/header.html\" id=\"gemprotheader\" class=\"gemprotheader\"></div>";
...
#print $conf::config::vcftools." --vcf ".$in_phased." --recode --from-bp ".$gene_start." --to-bp ".$gene_stop." --chr ".$chr." --out ".$select_phased;
            ...
            print HTMLS
"<head><title>Summary results </title><link rel=\"stylesheet\" type=\"text/css\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot.css\"/><link rel=\"icon\" type=\"image/png\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot16x16.png\" sizes=\"16x16\"/><link rel=\"icon\" type=\"image/png\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot32x32.png\" sizes=\"32x32\"/><link rel=\"icon\" type=\"image/png\" href=\"http://lysine.univ-brest.fr/GEMPROT/gemprot186x186.png\" sizes=\"186x186\"/><script type=\"text/javascript\" src=\"http://lysine.univ-brest.fr/GEMPROT/gemprot.js\"></script></head>\n";
            print HTMLS
"<div w3-include-html=\"http://lysine.univ-brest.fr/GEMPROT/header.html\" id=\"gemprotheader\" class=\"gemprotheader\"></div>";
            print HTMLS
"<div class=\"goback\"><a href=\"../\">Change Transcript</a></div>";
            ...
            print HTMLS
"<div class=\"freqsummarytablediv\"><table class=\"freqsummarytable\">";
            print HTMLS
"<thead><tr><th>Sample</th><th>Haplotype 1</th><th>Haplotype 2</th></tr></thead><tbody>";
...
"\n################ \n It is non-coding gene. Please check if you taking the data on the same reference genome\n################\n\n";
            ...
            foreach my $line_sample (@sample_id) {
                ...
                $nb_aa = $aa_pos - 1;
                my $htlm_file =
                  $V_dir . "/" . $sample . "_" . $gene . "_result.html";
                open HTML, ">" . $htlm_file;
                print HTML
...
"<div w3-include-html=\"http://lysine.univ-brest.fr/GEMPROT/header.html\" id=\"gemprotheader\" class=\"gemprotheader\"></div>";
                print HTML
"<div class=\"goback\"><a href=\"../\">Results summary</a></div>";
...
#my ($sequence_ALref2,$sequence_ALprot2)=Fonction::Sequence_comparaison($sequence_protref2, $sequence_prot2);
                ...
                print HTMLS "<tr><td><a href=Visual/"
                  . $sample . "_"
                  . $gene
                  . "_result.html>"
                  . $sample
                  . "</a></td><td class=\"haplotype\">$mut_1b</td><td class=\"haplotype\">$mut_2b</td>";

                #print Dumper (\%dif_hap);
                my $sample_mut_file =
                  $tmp_dir . $gene . ".mutation_by_hap_" . $sample . ".txt";
...
#print "Rscript Plot_new_annotation.R -m ".$sample_mut_file." -d ".$dom_file." -l ".$aa_pos." -p ".$V_dir."/".$gene."_".$sample." -s yes\n";
            ...
            foreach $hm ( keys %{ $dif_hap{ $gene } } ) {
                ...
                print GMF $gene . "\t"
                  . $hm . "\t"
                  . $dif_hap{ $gene }{ $hm } . "\t"
                  . $dif_hap{ $gene }{ $hm }{ "nb" } / $nb_hap_tot . "\t"
                  . $dif_hap{ $gene }{ $hm }{ "Sample" } . "\n";
...
"<div class=\"freqsummarytablediv\"><table class=\"freqsummarytable\">";
            print HTMLS
"<thead><tr><th>Gene</th><th>Haplotype</th><th>No. of chromosomes</th><th>Frequency</th><th>Individuals</th></tr></thead><tbody>";
            my $hp;
            foreach $hp ( keys %{ $dif_hap{ $gene } } ) {

                #print $gene."\t".$hm."\t";
                my $freq = sprintf( "%.3g",
                    $dif_hap{ $gene }{ $hp }{ "nb" } / $nb_hap_tot );
                print HTMLS
"<tr><td class=\"gene\">$gene</td><td class=\"haplotype\">$hp</td><td class=\"nchr\">$dif_hap{$gene}{$hp}{\"nb\"}</td><td class=\"freq\">$freq</td><td>";
                my @sample_split =
                  split( /,/, $dif_hap{ $gene }{ $hp }{ "Sample" } );
                foreach my $sp (@sample_split) {
                    print HTMLS "<a href=Visual/"
                      . $sp . "_"
                      . $gene
                      . "_result.html>"
                      . $sp . "</a> ";
