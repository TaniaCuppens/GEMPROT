...
#labels
if (mode=="indiv"){
	text(-(limt*2), 2.6, labels="hap1", font=1, family="mono",col="blue2", cex=0.9, srt=0, adj = 0)
	text(-(limt*2), 2.4, labels="hap2", font=1, family="mono",col="orangered2", cex=0.9, srt=0, adj = 0)
}
ndomain_out <- 0
